...
public class Admin_Delete_Templates extends Config {
	@Test
	public void delete_templates() throws Exception {
		...
		try {
			...
			for (int i = 1; i <= lib1.rowCount; i++) {
				...
				String templateDelete = lib1.getExcelData("deleteTemplates", i,
						0, filePath);
				driver.findElement(
						By.xpath("//tr[td[2][div[a[contains(text(),'"
								+ templateDelete + "')]]]]//td[1]//div[2]"))
						.click();
				driver.findElement(
						By.id("reportTab:reportTemplateform:reportTemplateGrid:deletetemplate"))
						.click();
				Thread.sleep(3000);
