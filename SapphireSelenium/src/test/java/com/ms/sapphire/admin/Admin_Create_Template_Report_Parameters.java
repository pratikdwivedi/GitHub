...
public class Admin_Create_Template_Report_Parameters extends Config {
	@Test
	public void create_template_report_parameters() throws Exception {
		...
		try {
			...
			e.printStackTrace();
			Assert.fail("Error in creation of template report parameter");

		}
		finally{
			Reporter.log("This test case is to verify creation of template report parameters");
		}
	}
