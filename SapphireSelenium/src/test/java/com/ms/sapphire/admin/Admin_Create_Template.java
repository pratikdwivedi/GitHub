...
public class Admin_Create_Template extends Config {
	@Test
	public void create_template() throws Exception {
		...
		try {
			...
			for (int i = 1; i <= lib1.rowCount; i++) {
				...
				String templateRPT = lib1.getExcelData("templates", i, 6,
						filePath);
				driver.findElement(
						By.xpath("//div[contains(@id,'reportTemplateDetailForm:simpleid')]//div[1]//label"))
						.click();
				Thread.sleep(3000);
			...
			e.printStackTrace();
			Assert.fail("Error in creation of report template");
		}finally{
			Reporter.log("This test case is to verify creation of report template");
		}
	}
