	...
	public void delete_user_role() throws Exception {
		...
		try {
			...
			for (int i = 1; i <= lib1.rowCount; i++) {
				...
				String userRoleDelete = lib1.getExcelData("userRoleDelete", i,
						0, filePath);
				driver.findElement(
						By.xpath("//tr[td[2][div[a[text()='" + userRoleDelete
								+ "']]]]//td[1]//div[2]")).click();
				driver.findElement(By.id("roleform:roleGrid:deleteRole"))
						.click();
				Thread.sleep(3000);
