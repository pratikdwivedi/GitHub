...
public class Admin_Create_TemplateGroups extends Config {
	@Test
	public void create_template_group() throws Exception {
		...
		try {
			...
			e.printStackTrace();
			Assert.fail("Error in creation of template groups");
		}
		finally{
			Reporter.log("This test case is to verify creation of template groups");
		}
	}
