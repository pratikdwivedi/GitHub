...
public class Admin_Delete_Event_Groups extends Config {
	@Test
	public void delete_event_group() throws Exception {
		...
		try {
			...
			for (int i = 1; i <= lib1.rowCount; i++) {
				...
				String eventGroupDelete = lib1.getExcelData("eventGroupDelete",
						i, 0, filePath);
				driver.findElement(
						By.xpath("//tr[td[2][div[a[contains(text(),'"
								+ eventGroupDelete + "')]]]]//td[1]//div[2]"))
						.click();
				driver.findElement(
						By.id("eventGroupform:eventGroupGrid:deleteEventGroup"))
						.click();
				Thread.sleep(3000);
