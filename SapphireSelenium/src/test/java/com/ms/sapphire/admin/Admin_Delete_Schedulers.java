...
public class Admin_Delete_Schedulers extends Config {
	@Test
	public void delete_schedulers() throws Exception {
		...
		try {
			...
			for (int i = 1; i <= lib1.rowCount; i++) {
				...
				String schedulerDelete = lib1.getExcelData("deleteScheduler",
						i, 0, filePath);
				driver.findElement(
						By.xpath("//tr[td[3][div[a[contains(text(),'"
								+ schedulerDelete + "')]]]]//td[1]//div[2]"))
						.click();
				driver.findElement(
						By.id("schedulerform:schedulerGrid:deleteScheduler"))
						.click();
				Thread.sleep(3000);
