...
public class Port_Delete_Dossier extends Config {
	@Test
	public void delete_dossier() throws Exception {
		...
		try {
			...
			for (int i = 1; i <= lib1.rowCount; i++) {
				...
				Thread.sleep(5000);
				String selectMaster = lib1.getExcelData("deleteDossier", i, 0,
						filePath);
				driver.findElement(
				...
				driver.findElement(
						By.xpath("//tbody[contains(@id,'masterform:masterGrid_data')]//a[contains(text(),'"
								+ selectMaster + "')]")).click();
				driver.findElement(
						By.xpath("//form[contains(@id,'portLeftPane')]//div[1]/ul/li[3]/a/span"))
						.click();
				String deleteDossier = lib1.getExcelData("deleteDossier", i, 1,
						filePath);
				driver.findElement(
						By.xpath("//div[contains(@id,'dossierform:dossierGrid')]//input[contains(@type,'text')]"))
						.sendKeys(deleteDossier);
				driver.findElement(
						By.xpath("//div[contains(@id,'dossierform:dossierGrid')]//button[1]/span[contains(text(),'Search')]"))
						.click();
				Thread.sleep(3000);
				driver.findElement(
						By.xpath("//tr[td[3][div[a[text()='" + deleteDossier
								+ "']]]]//td[1]//div[2]")).click();
				Thread.sleep(3000);
				driver.findElement(
						By.id("dossierform:dossierGrid:removeDossier")).click();
				Thread.sleep(3000);
				driver.switchTo().activeElement();
				driver.findElement(By.id("removeConfirmForm:confirmRemove"))
						.click();
				String msgDossier = driver
						.findElement(
				...
				Assert.assertEquals(msgDossier,
						"Selected record(s) are deleted successfully");
				Thread.sleep(3000);
			}// for
		}// try
		catch (Throwable e) {
