	...
	public void delete_action() throws Exception {
		...
		try {
			...
			for (int i = 1; i <= lib1.rowCount; i++) {
				...
				Thread.sleep(5000);
				String selectMaster = lib1.getExcelData("deleteAction", i, 0,
						filePath);
				driver.findElement(
				...
				driver.findElement(
						...
						.click();
				String selectActionPlan = lib1.getExcelData("deleteAction", i,
						1, filePath);
				driver.findElement(
				...
				Thread.sleep(3000);
				String selectAction = lib1.getExcelData("deleteAction", i, 2,
						filePath);
				driver.findElement(
				...
				if (classCheckbox
					...
					driver.findElement(
							By.xpath("//tr[td[3][div[a[contains(text(),'"
									+ selectAction + "')]]]]//td[1]//div[2]"))
							.click();
					driver.findElement(
							By.id("actionPlanDetailForm:itemActionGrid:removeAction"))
							.click();
					Thread.sleep(3000);
					driver.switchTo().activeElement();
					driver.findElement(By.id("removeConfirmForm:confirmRemove"))
							.click();
					String msgAction = driver
							.findElement(
					...
					Assert.assertEquals(msgAction,
							"Published actions cannot be removed.");
					Thread.sleep(3000);
				} else {
					driver.findElement(By.id("actionDetailForm:close")).click();
					driver.findElement(
					...
					System.out.println(msgAction);
					Assert.assertEquals(msgAction,
							"Selected action(s) removed successfully.");
					Thread.sleep(3000);
				}
			}// for
		}// try
