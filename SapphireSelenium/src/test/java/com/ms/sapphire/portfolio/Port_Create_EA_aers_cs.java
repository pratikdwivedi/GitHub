...
public class Port_Create_EA_aers_cs extends Config {
	...
	@Test
	public void create_topic_alerts_ea_aers() throws Exception {
		...
		try {
			...
			for (int i = 1; i <= lib1.rowCount; i++) {
				...
				String masterName = lib1.getExcelData("topicalerts", i, 0,
						filePath);
				...
				Thread.sleep(5000);
				driver.findElement(
						By.xpath("//div[contains(@id,'leftNavPanel_content')]//form/div[1]/ul/li[4]/a/span"))
						.click();
				driver.findElement(
						By.xpath("//div[contains(@id,'tabView')]//ul/li[3]/a"))
						.click();
				List<WebElement> listTopics = driver
						.findElements(By
								.xpath("//tbody[contains(@id,'tabView:masterTopictListForm:topicGrid_data')]//tr/td[2]/div/div/a"));
				String topicName = lib1.getExcelData("topicalerts", i, 1,
						filePath);
				...
				driver.findElement(
						By.id("tabView:topicDetailForm:tabView:analysisGrid:startAnalysis"))
						.click();// create button clicked
				String alertType = lib1.getExcelData("topicalerts", i, 2,
						filePath);
				WebElement weAlert = driver.findElement(By.linkText(alertType));
				act.moveToElement(weAlert).click();// FDA AERS clicked
				act.perform();
				Thread.sleep(3000);
				String drugLevel = lib1.getExcelData("topicalerts", i, 5,
						filePath);
				driver.findElement(
						By.id("analysisCriteriaForm:tabView:drugsetGrid:0:fieldId_label"))
						.click();// drug level clicked
				driver.findElement(
						By.xpath("//div[contains(@id,'analysisCriteriaForm:tabView:drugsetGrid:0:fieldId_panel')]//div/ul/li[contains(text(),'"
								+ drugLevel + "')]")).click();// drug level
																// select
				Thread.sleep(3000);
				driver.findElement(
						By.id("analysisCriteriaForm:tabView:drugsetGrid:0:lookupEADrug"))
						.click();
				String dictLevel = lib1.getExcelData("topicalerts", i, 6,
						filePath);
				driver.findElement(
						By.id("productLookupEAForm:productLookupGrid:searchLevel_label"))
						.click();// dict level clicked
				Thread.sleep(2000);
				driver.findElement(
						By.xpath("//div[contains(@id,'productLookupEAForm:productLookupGrid:searchLevel_panel')]//div/ul/li[contains(text(),'"
								+ dictLevel + "')]")).click();
				Thread.sleep(2000);
				String drugNamePort = lib1.getExcelData("topicalerts", i, 7,
						filePath);
				driver.findElement(
						By.id("productLookupEAForm:productLookupGrid:srcTxtId"))
						.sendKeys(drugNamePort);// drug name passed
				driver.findElement(
						By.xpath("//div[contains(@id,'productLookupEAForm:productLookupGrid')]//table/thead/tr/th/div/div/span/button[1]/span"))
						.click();// search clicked
				Thread.sleep(2000);
				driver.findElement(
						By.xpath("//tbody[contains(@id,'productLookupEAForm:productLookupGrid_data')]//tr/td/div/div/div[2]"))
						.click();
				Thread.sleep(2000);
				driver.findElement(By.id("productLookupEAForm:selectProduct"))
						.click();
				Thread.sleep(3000);
				String groupTab = lib1.getExcelData("topicalerts", i, 13,
						filePath);
				driver.findElement(By.linkText(groupTab)).click();
				if (groupTab.equals("Step")) {
					if (alertType.equals("FDA AERS")) // Group in FDA aers
					{
						String groupByaers = lib1.getExcelData("topicalerts",
								i, 14, filePath);
						Thread.sleep(2000);
						driver.findElement(
								By.xpath("//table[contains(@id,'analysisCriteriaForm:groupTabView:singlePanelView')]//tbody/tr/td[2]/label[contains(text(),'"
										+ groupByaers + "')]")).click();
						Thread.sleep(2000);
					} else if (alertType.equals("Company safety")) // Group in
																	// CS
					{
						String groupByCS = lib1.getExcelData("topicalerts", i,
								14, filePath);
						Thread.sleep(2000);
						driver.findElement(
								By.xpath("//div[contains(@id,'analysisCriteriaForm:groupTabView:singleTab')]//div/div//tr/td[2]/label[contains(text(),'"
										+ groupByCS + "')]")).click();
						Thread.sleep(2000);
					}
					...
					if (alertType.equals("FDA AERS")) // Group in FDA aers
					{
						...
						for (int j = 1; j <= lib1.rowCount; j++) {
							String parallelGroupBy = lib1.getExcelData(
									"parallel-nested", j, 0, filePath);
							WebElement w = driver
									.findElement(By
											.xpath("//tr[td[2][div[label[contains(text(),'"
													+ parallelGroupBy
													+ "')]]]]//td[1]/div/div/div[2]"));
							w.click();
						}
																	...
																	// CS
					{
						for (int k = 1; k <= lib1.rowCount; k++) {
							String CSparallelGroupBy = lib1.getExcelData(
									"parallel-nested", k, 3, filePath);
							WebElement wCS = driver
									.findElement(By
											.xpath("//tr[td[2][div[label[contains(text(),'"
													+ CSparallelGroupBy
													+ "')]]]]//td[1]/div/div/div[2]"));
					...
					if (alertType.equals("FDA AERS")) // Group in FDA aers
					{
						for (k = 1; k <= lib1.rowCount; k++) {
							String nestedGroupBy = lib1.getExcelData(
									"parallel-nested", k, 1, filePath);
							Select sl = new Select(
									driver.findElement(By
											.id("analysisCriteriaForm:groupTabView:groupByNested")));
							sl.selectByVisibleText(nestedGroupBy);
							driver.findElement(
									By.xpath("//div[contains(@id,'analysisCriteriaForm:groupTabView:nestedTab')]//button[1]/span"))
									.click();
							Thread.sleep(3000);
						}
						System.out.println("Pivote selection start.....");
						String pivoteEA = lib1.getExcelData("parallel-nested",
								1, 2, filePath);
						...
						Thread.sleep(3000);
						WebElement wmt = driver
								.findElement(By
										.xpath("//tr[td[2][div[label[contains(text(),'"
												+ pivoteEA
												+ "')]]]]//td[1]/div/div/div[2][contains(@class,'ui-radiobutton-box ui-widget ui-corner-all ui-radiobutton-relative ui-state-default')]"));
						Thread.sleep(3000);
						wmt.click();
						Thread.sleep(2000);
					...
					{
						for (k = 1; k <= lib1.rowCount; k++) {
							String CSnestedGroupBy = lib1.getExcelData(
									"parallel-nested", k, 4, filePath);
							Select sl = new Select(
									driver.findElement(By
											.id("analysisCriteriaForm:groupTabView:groupByNested")));
						...
						System.out.println("Pivote selection start.....");
						String pivoteCS = lib1.getExcelData("parallel-nested",
								1, 5, filePath);
						driver.findElement(By.id("analysisCriteriaForm:expbut"))
								.click();
						Thread.sleep(3000);
				...
				WebElement alertCheck = driver
						.findElement(By
								.xpath("//tbody[contains(@id,'itemform:itemGrid_data')]//tr/td[5]/div/a"));
