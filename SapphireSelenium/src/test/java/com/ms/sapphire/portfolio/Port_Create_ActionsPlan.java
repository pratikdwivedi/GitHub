...
public class Port_Create_ActionsPlan extends Config {
	...
	@Test
	public void create_action_plan() throws Exception {
		...
		try {
			...
			for (int i = 1; i <= lib1.rowCount; i++) {
				...
				String masterName = lib1.getExcelData("actionsplan", i, 0,
						filePath);
				...
				driver.findElement(
						By.xpath("//div[contains(@id,'actionPlanListForm:actionPlanGrid')]//span/button[1]/span[contains(text(),'Create')]"))
						.click();
				String planName = lib1.getExcelData("actionsplan", i, 1,
						filePath);
				driver.findElement(By.id("actionPlanDetailForm:actionPlanName"))
						.sendKeys(planName);

				String planStartDate = lib1.getExcelData("actionsplan", i, 2,
						filePath);
				driver.findElement(
						By.id("actionPlanDetailForm:planStartDate_input"))
						.clear();
				driver.findElement(
						By.id("actionPlanDetailForm:planStartDate_input"))
						.sendKeys(planStartDate);

				String planEndDate = lib1.getExcelData("actionsplan", i, 3,
						filePath);
				driver.findElement(
						By.id("actionPlanDetailForm:planEndDate_input"))
						.clear();
				driver.findElement(
						By.id("actionPlanDetailForm:planEndDate_input"))
						.sendKeys(planEndDate);

				String actualStartDate = lib1.getExcelData("actionsplan", i, 4,
						filePath);
				driver.findElement(
						By.id("actionPlanDetailForm:actualStartDate_input"))
						.clear();
				driver.findElement(
						By.id("actionPlanDetailForm:actualStartDate_input"))
						.sendKeys(actualStartDate);

				String actualEndDate = lib1.getExcelData("actionsplan", i, 5,
						filePath);
				driver.findElement(
						By.id("actionPlanDetailForm:actualEndDate_input"))
						.clear();
				driver.findElement(
						By.id("actionPlanDetailForm:actualEndDate_input"))
						.sendKeys(actualEndDate);

				String owner = lib1.getExcelData("actionsplan", i, 6, filePath);
				driver.findElement(By.id("actionPlanDetailForm:lookupUser"))
						.click();
				...
				driver.findElement(
						By.id("actionPlanDetailForm:actionPlanDescription"))
						.sendKeys(desc);
				driver.findElement(By.id("actionPlanDetailForm:savePlan"))
						.click();
			...
			e.printStackTrace();
			Assert.fail("Error in creation of action plans ");
		}
		finally{
			Reporter.log("This test case is to verify creation of action plans");
		}
	}// method close
}
