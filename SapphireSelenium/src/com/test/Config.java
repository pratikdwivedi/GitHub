...
public class Config extends ExcelLibrary{
	...
	public void doLogIn() {
		...
		un=lib2.getExcelData("loginlogout", 1, 0,"SapphireFiles\\AutomationTestData.xls");
		pw=lib2.getExcelData("loginlogout", 1, 1,"SapphireFiles\\AutomationTestData.xls");
	...
	public static void setClipboardData(String string) {
	 ...
	 public void  takeScreenShot(Throwable e, String fileName) {
	        ...
	        try {
	            FileUtils.copyFile(screenShot, new File("ScreenShotsOfErrors\\"+fileName+ ".png"));
