...
public class OracleDB {
	...
	@Test
	public void oracleDBconnect() throws Exception {
		try {
			Class.forName("oracle.jdbc.driver.OracleDriver");
			con = DriverManager.getConnection(
					"jdbc:oracle:thin:@//127.0.0.1:1521/XE", "hr", "hr"); // My

			/*
			 * con = DriverManager.getConnection(
			 * "jdbc:oracle:thin:@//192.168.1.20:1521/XE", "system",
			 * "manager123");
			 */
			...
			/*
			 * String query = "select * from tab"; rst
			 * =stmt.executeQuery(query); while (rst.next()) { dbvalue =
			 * rst.getString(1);
			 * 
			 * }
			 */
