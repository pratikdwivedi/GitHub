...
public class Admin_Delete_Product_Groups extends Config{
	...
	public void deleteProductGroup() throws Exception{
		...
		String productGroupDelete=lib1.getExcelData("productGroupDelete",i, 0,filePath);
		driver.findElement(By.xpath("//tr[td[2][div[a[contains(text(),'"+productGroupDelete+"')]]]]//td[1]//div[2]")).click();
		driver.findElement(By.id("productGroupform:productGroupGrid:deleteProductGroup")).click();
		Thread.sleep(3000);
