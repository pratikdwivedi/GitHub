...
public class Admin_Delete_User_Groups extends Config{
	...
	public void deleteUserGroup() throws Exception{
		...
		String userGroupdelete=lib1.getExcelData("userGroupDelete",i, 0,filePath);
		driver.findElement(By.xpath("//tr[td[3][div[a[text()='"+userGroupdelete+"']]]]//td[1]//div[2]")).click();
		driver.findElement(By.id("userGroupform:userGroupGrid:deleteGroup")).click();
		Thread.sleep(3000);
