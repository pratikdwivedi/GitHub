...
public class Admin_Delete_Product extends Config{
	...
	public void deleteProduct() throws Exception{
		...
		String productDelete=lib1.getExcelData("productDelete",i, 0,filePath);
		driver.findElement(By.xpath("//tr[td[2][div[div[a[text()='"+productDelete+"']]]]]//td[1]//div[2]")).click();
		driver.findElement(By.id("productform:productGrid:deleteMedProduct")).click();
		Thread.sleep(3000);
