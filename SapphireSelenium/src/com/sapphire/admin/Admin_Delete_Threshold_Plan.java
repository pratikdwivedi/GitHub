...
public class Admin_Delete_Threshold_Plan extends Config{
	...
	public void deleteThreshold() throws Exception{
		...
		String thresholdDelete=lib1.getExcelData("deleteThreshold",i, 0,filePath);
		driver.findElement(By.xpath("//tr[td[2][div[a[contains(text(),'"+thresholdDelete+"')]]]]//td[1]//div[2]")).click();
		driver.findElement(By.id("tresHoldMatrixform:tresHoldMatrixGrid:deleteTreshHoldMatrix")).click();
		Thread.sleep(3000);
