...
public class Admin_Delete_Template_Group extends Config{
	...
	public void deleteTemplateGroup() throws Exception{
		...
		driver.findElement(By.xpath("//div[contains(@id,'reportTab')]//ul/li[3]/a")).click();
		String groupName=lib1.getExcelData("deleteTemplateGroup",i, 0,filePath);
		driver.findElement(By.xpath("//tr[td[2][div[a[contains(text(),'"+groupName+"')]]]]//td[1]//div[2]")).click();
		driver.findElement(By.id("reportTab:templateGroupform:templateGroupGrid:deleteGroup")).click();
		Thread.sleep(3000);
