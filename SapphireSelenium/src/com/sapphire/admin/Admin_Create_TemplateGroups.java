...
public class Admin_Create_TemplateGroups extends Config{
	...
	public void TestMethodCreateTemplateGroup() throws Exception{
		...
		String groupName=lib1.getExcelData("templategroup", i, 0,filePath);
		driver.findElement(By.id("reportTab:templateGroupform:templateGroupGrid:createTemplateGroup")).click();
		driver.findElement(By.id("templateGroupDetailForm:groupnameid")).sendKeys(groupName);
		String datasource=lib1.getExcelData("templategroup", i, 1,filePath);
		driver.findElement(By.id("templateGroupDetailForm:datasourceId_label")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//div[contains(@id,'templateGroupDetailForm:datasourceId_panel')]/div[1]/ul[1]/li[text()='"+datasource+"']")).click();
		Thread.sleep(2000);
		String description=lib1.getExcelData("templategroup", i, 2,filePath);
		driver.findElement(By.id("templateGroupDetailForm:descriptionId")).sendKeys(description);
	//	driver.findElement(By.id("templateGroupDetailForm:cancle")).click();//cancel
		driver.findElement(By.id("templateGroupDetailForm:saveTemplateGroupId")).click();//save
		Thread.sleep(3000);
	//	driver.findElement(By.id("templateGroupDetailForm:saveCloseTemplateGroupId")).click();//save & close
		System.out.println("Template group creation complete............"+groupName);
