...
@Test
	public void TestMethodcheckBox() throws Exception{
	try{
	act =new Actions(driver);
	driver.findElement(By.linkText("WORKSPACE")).click();
	driver.findElement(By.linkText("ANALYSIS")).click();
	Thread.sleep(5000);
	Boolean status1=driver.findElement(By.xpath(".//*[@id='analysisform:saCriteriaTab:analysisGrid_data']/tr[1]/td[1]/div/div/div[2]")).isSelected();
	System.out.println(status1);
	driver.findElement(By.xpath(".//*[@id='analysisform:saCriteriaTab:analysisGrid_data']/tr[1]/td[1]/div/div/div[2]")).click();
	...
	driver.findElement(By.id("analysisform:saCriteriaTab:analysisGrid:deleteAnalysis")).click();		
	Thread.sleep(3000);
