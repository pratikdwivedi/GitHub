...
public class Create_EA_aers extends Config{
	...
	public void TestMethodCreateEAaers() throws Exception{
		...
		WebElement EA=driver.findElement(By.id("analysisform:saCriteriaTab:analysisGrid:j_idt101"));
		act.moveToElement(EA).click();//FDA AERS clicked
		act.perform();
		Thread.sleep(5000);
		System.out.println("AERS clicked");
		Thread.sleep(5000);
		driver.findElement(By.id("analysisCriteriaForm:tabView:drugsetGrid:0:genTradeName")).sendKeys("raptiva");
		System.out.println("drug name passed");
		driver.findElement(By.id("analysisCriteriaForm:groupTabView:singlePanelView:groupByStep:9")).click();
		...
		driver.findElement(By.id("saveAnalysisForm:saveTabPanel:rootAnalysisName")).sendKeys("NewAutomateAnalysis");
