...
public class Port_Delete_Docket extends Config{
	...
	public void TestMethodPortDeleteDocket() throws Exception{
		...
		try {
			...
			Thread.sleep(5000);
			String selectMaster=lib1.getExcelData("deleteDocket", i, 0, filePath);
			...
			driver.findElement(By.xpath("//div[contains(@id,'tabView')]//ul/li[2]/a")).click();
			String deleteDocket=lib1.getExcelData("deleteDocket", i, 1, filePath);
			driver.findElement(By.xpath("//tr[td[2][div[div[a[contains(text(),'"+deleteDocket+"')]]]]]//td[1]//div[2]")).click();
			driver.findElement(By.id("tabView:masterArtifactListForm:masterFileGrid:deleteArtifact")).click();
			Thread.sleep(3000);
			driver.switchTo().activeElement();
			driver.findElement(By.id("removeConfirmForm:confirmRemove")).click();
			String msgDocket=driver.findElement(By.xpath("//div[contains(@class,'ui-growl-item-container ui-state-highlight ui-corner-all ui-helper-hidden ui-shadow')]//div/div/p")).getText();
